...
## Triggers
Activates when the user mentions 一键发币, 发币, 创建代币, launch token, create token, deploy token, mint token, launch meme coin, token-launch, pump.fun launch, or wants to create a new token on Solana or BSC launchpads.
